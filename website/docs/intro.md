...
Talos is a self-hosted AI chief of staff. It connects to your own LLM providers (OpenAI, Anthropic, Google, OpenRouter), executes scheduled tasks, and extends its capabilities through a file-based plugin system.
...
- **Extensible Plugins** — File-based plugin system with manifest-driven definitions.
...
│  Agent Core · Scheduler · Plugin Runner      │
...
Talos is a "dumb relay + local executor." All intelligence lives in the remote LLM. Talos orchestrates the conversation, executes plugins locally, and delivers results.
